 ...
 */
export function configure({ middlewareApp, rootUrl, usersColl, secretKey }) {
  invariant(
    middlewareApp,
  ...
  _oauthManager = new OAuthLoginManager(_emitter, middlewareApp, rootUrl, secretKey);
  _basicManager = new BasicLoginManager(_emitter, middlewareApp, rootUrl, secretKey);
}
