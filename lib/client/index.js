...
// Internals
const _basicLogin = new BasicLoginClient();
const _oauthLogin = new OAuthLoginClient();
const _updateUserEmitter = new EventEmitter();
const _handleSuccessLogin = (userId) => {
...
export function register(username, password) {
  return _basicLogin.register(username, password)
    .then(_handleSuccessLogin);
}
